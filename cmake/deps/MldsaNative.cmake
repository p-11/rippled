...
option(
    mldsa_avx2
    "Build mldsa-native with the AVX2 native backend (x86_64 only)"
    OFF
)
...
target_include_directories(
    mldsa_native
    PUBLIC $<BUILD_INTERFACE:${MLDSA_NATIVE_ROOT}/mldsa>
)

target_compile_definitions(mldsa_native PUBLIC MLD_CONFIG_PARAMETER_SET=44)
